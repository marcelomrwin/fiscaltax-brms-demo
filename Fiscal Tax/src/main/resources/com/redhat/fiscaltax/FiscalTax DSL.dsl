...
[consequence]Consultar e Aplicar aliquota para o Municipio e Servico do item = $ret.setAliquotaISS(ExternalResourceClient.consultarAliquota($ops.getCdMunicipio(), $ops.getCdServicoDestino())); 
update ($ret);
...
update($ret);
[consequence]Acumular valor pago Imposto de Renda = ExternalResourceClient.adicionarAcumuloIR($ope.getDocumento(),$ope.getDtEmissao(),$ope.getFJ(),$ops.getCdMunicipio(),$ops.getCdServicoDestino(),$ret.getVlImpostoIR(),$ret.getAliquotaIR());
